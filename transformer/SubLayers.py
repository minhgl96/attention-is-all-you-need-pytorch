...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, mask=None):
        ...
        residual = q  # [batch size, num q tokens, d_model]
        ...
        output = self.dropout(self.fc(output))  # [batch size, num q tokens, d_model]
...
class PositionwiseFeedForward(nn.Module):
    ...
    def forward(self, x):
        residual = x  # [batch size, num q tokens, d_model]
